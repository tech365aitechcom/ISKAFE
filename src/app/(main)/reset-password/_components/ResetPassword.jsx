...
const ResetPassword = () => {
  ...
  const [tokenExpired, setTokenExpired] = useState(false); // ✅ Add this line
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        /expired|invalid/i.test(errorMessage)
      ) {
        enqueueSnackbar(
        ...
        setTokenExpired(true); // ✅ Mark token as expired
        return;
      }
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen bg-black text-white'>
      <p className='text-xl mb-4'>This reset link has expired or is invalid.</p>
      <Link href='/forgot-password' className='text-red-500 underline'>
        Request a new one
      </Link>
    </div>
  )
