      ...
      <div className='lg:col-span-1'>
        <div className='bg-[#1b0c2e] rounded-lg p-6 mb-6'>
          {eventDetails?.poster ? (
            <img
              ...
              onError={(e) => {
                ...
                e.target.parentElement.innerHTML = `
                  <div class='w-full aspect-[3/4] rounded-lg bg-gradient-to-br from-purple-900 to-purple-700 flex items-center justify-center mb-6'>
            ...
            <div className='w-full aspect-[3/4] rounded-lg bg-gradient-to-br from-purple-900 to-purple-700 flex items-center justify-center mb-6'>
